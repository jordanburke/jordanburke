...
| **[ts-builds-template](https://github.com/jordanburke/ts-builds-template)** | GitHub template for new functype-style libraries |
| **[typescript-library-template](https://github.com/jordanburke/typescript-library-template)** | Standalone starter for TypeScript libraries |
| **[ts-case-convert](https://github.com/jordanburke/ts-case-convert)** | Type-safe string case conversion (camelCase, snake_case) |
| **[supabase-typed-query](https://github.com/jordanburke/supabase-typed-query)** | Type-safe Supabase query builder |
...
| **[dakboard-mcp-server](https://github.com/jordanburke/dakboard-mcp-server)** | DAKboard display and dashboard management |
| **[duckpond-mcp-server](https://github.com/jordanburke/duckpond-mcp-server)** | Per-user DuckDB analytics for AI agents |
| **[agent-todo](https://github.com/sapienapps/agent-todo)** | Multi-provider task management agent |

**SapientsAI MCP Servers** (via [SapientsAI](https://github.com/sapientsai)):
